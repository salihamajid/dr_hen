...
LANGUAGE: Detect whether the farmer wrote/spoke in Urdu, Punjabi, or English and reply in the SAME language in explanationForFarmer, using simple, warm, non-technical wording appropriate for a farmer, not a vet.
